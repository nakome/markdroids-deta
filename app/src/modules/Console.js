...
(() => {
    ...
    style.type = "text/css";
    style.textContent = [
        ".as-console-wrapper {position: fixed;bottom: 0;left: 0;right: 0;max-height: 150px;overflow-y: scroll;overflow-x: hidden;border-top: 1px solid var(--color-300);display: none;background: var(--color-50);}",
        ".as-console-wrapper.as-console-maximized { top: 0px; max-height: inherit; display:block; background:var(--color-50); border-top: none;  }",
        ".as-console {border: 1px solid var(--color-50);display: table;width: 100%;border-collapse: collapse;}",
        ".as-console-row { display: table-row; font-family: monospace; font-size: 10pt; }",
        ".as-console-timestamps .as-console-row:after {display: table-cell;padding: 3px 6px;color: var(--color-600);border: 1px solid var(--color-50);content: attr(data-date);vertical-align: top;background: var(--color-50);}",
        ".as-console-row + .as-console-row > * { border: 1px solid var(--color-50); }",
        ".as-console-row-code {width: 100%;white-space: pre-wrap;padding: 3px 5px;display: table-cell;font-family: monospace;font-size: 13px;vertical-align: middle;color: var(--color-950);}",
        ...
        ".as-console-dictionary { margin: 0; padding: 0 0 0 20px; background-color: var(--color-50); list-style: none; white-space: normal; }",
        ...
        ".as-console-type-label, .as-console-nil-value { color: var(--color-500); }",
        ".as-console-literal-value, .as-console-expandable-value .as-console-string-value { color: #C00; }",
        ".as-console-expandable-value .as-console-string-value::before, .as-console-expandable-value .as-console-string-value::after { content: '\"'; color: var(--color-950); }",
        ...
        ".as-console-table { width: 100%; table-layout: fixed; border-collapse: collapse; background-color: var(--color-50); border: 1px solid var(--color-500); }",
        ".as-console-table thead { background-color: var(--color-100); border-bottom: 1px solid var(--color-500); }",
        ".as-console-table th { font-weight: normal; text-align: left; }",
        ".as-console-table th, .as-console-table td { padding: 3px 6px; border-style: solid; border-width: 0 1px; border-color: var(--color-500); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }",
        ".as-console-table tbody tr:nth-of-type(even) {background-color: var(--color-50);}",
